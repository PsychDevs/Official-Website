...
const projects = [
  {
    ...
    title: "DreamFitness",
    description:
      "Website for a fitness coach with personalized training plans and merchandise.",
    category: "Web Development",
    image:
      "./portfolio_projects/DreamFitness/dreamfitness-forlife.com_hero.png",
...
export default function PortfolioPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="m-5 mt-20  flex items-center justify-center">
              ...
              <article key={project.id} className="flex flex-col items-start">
                <div className="relative w-full">
                  <img
                    src={project.image}
                    alt={project.title}
                    className="aspect-[16/9] w-full rounded-lg object-contain sm:aspect-[2/1] lg:aspect-[3/2]"
                  />
      ...
      <section className="min-h-screen flex items-center justify-center">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Ready to transform your business with a stunning website? Get in
